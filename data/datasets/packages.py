...
class Packages(BaseImageDataset):
    """
    Packages
    """
    dataset_dir = 'Packages'

    def __init__(self, root='/home/zjs/Opensource_datasets', verbose=True, no_id=False, **kwargs):
