...
class ResNeXt(nn.Module):
    ...
    def __init__(self, baseWidth, cardinality, last_stride, layers, num_classes):
        """ Constructor
        Args:
...
def resnext50_ibn_a(baseWidth, cardinality, last_stride):
    ...
    """
    model = ResNeXt(baseWidth, cardinality, last_stride, [3, 4, 6, 3], 1000)
    return model
...
def resnext101_ibn_a(baseWidth, cardinality, last_stride):
    ...
    """
    model = ResNeXt(baseWidth, cardinality, last_stride, [3, 4, 23, 3], 1000)
    return model
...
def resnext152_ibn_a(baseWidth, cardinality, last_stride):
    ...
    """
    model = ResNeXt(baseWidth, cardinality, last_stride, [3, 8, 36, 3], 1000)
    return model